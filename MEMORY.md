...
## What this is
WhatsApp personal AI assistant for Sellify clients. It replaces the n8n-based
"Cue" assistant (migrating n8n → Railway). Users text a WhatsApp number; a
...
| Notes (Postgres) | ✅ Per-user isolated |
...
- `src/database.py` — tables `pa_users`, `pa_notes`, `pa_chat_history`
...
- `Postgres` `efca358d-a4c2-4900-aa37-286c6f44e9de` (`DATABASE_URL=${{Postgres.DATABASE_URL}}`)
...
6. Cue feature parity: Canon/RAG (pgvector), reminders, personal log, personas, photo/PDF
